...
function cadastrar(){
  bancoCadastro.push(new cadastroLogin(nome.value, 
    ...
    if((nome.value && sobrenome.value && cidade.value && estado.value && usuario.value && senha.value) != ''){
      ...
      location.assign('https://sistemaescola.netlify.app/assets/page/login/login.html')
...
function login(){
  if (usuario.value == "step@gmail.com" && senha.value == "jw") {
      ...
      location.assign('https://sistemaescola.netlify.app/assets/page/dashboard/dashboard.html')
      // window.location.href = 'file:///C:/Users/Andr%C3%A9%20Lima/OneDrive/Documentos/sistemaescolaJS-FINAAAAL/assets/page/dashboard/dashboard.html'
    }else{
